# Topic modelling constants

class TopicModellingConstants:

	MALLET_PATH = "TopicModelling/mallet-2.0.8/bin/mallet"
	CLEANED_DOCUMENT_THRESHOLD = 2
	URL_REGEX = r"(?i)\b((?:https?://|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}/)(?:[^\s()<>]+|\(([^\s()<>]+|(\([^\s()<>]+\)))*\))+(?:\(([^\s()<>]+|(\([^\s()<>]+\)))*\)|[^\s`!()\[\]{};:\'\".,<>?«»“”‘’]))"
	SPECIAL_CHARACTER_REGEX = r"[-()\"\'#/@;:<>{}+=~|.?,!“’…—_”\$\&\*]"
	NUMBER_REGEX = r'[0-9]+'
	SHORT_HAND_DICTIONARY = {
		r"i'm ": "i am ",
		r"he's ": "he is ",
		r"she's ": "she is ",
		r"that's ": "that is ",
