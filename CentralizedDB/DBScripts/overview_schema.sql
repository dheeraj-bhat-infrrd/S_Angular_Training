...
CREATE TABLE `overview_branch` (
  ...
  `sps_score` int(11) DEFAULT NULL,
  `total_detractors` int(11) DEFAULT NULL,
  `detractors_percentage` int(11) DEFAULT NULL,
  `total_passives` int(11) DEFAULT NULL,
  `passives_percentage` int(11) DEFAULT NULL,
  `total_promoters` int(11) DEFAULT NULL,
  `promoter_percentage` int(11) DEFAULT NULL,
  `total_corrupted` int(11) DEFAULT NULL,
  `corrupted_percentage` int(11) DEFAULT NULL,
  `total_mismatched` int(11) DEFAULT NULL,
  `mismatched_percentage` int(11) DEFAULT NULL,
  `total_duplicate` int(11) DEFAULT NULL,
  `duplicate_percentage` int(11) DEFAULT NULL,
  `total_archieved` int(11) DEFAULT NULL,
  `archieved_percentage` int(11) DEFAULT NULL,
  `total_incomplete_transactions` int(11) DEFAULT NULL,
  `total_survey_sent` int(11) DEFAULT NULL,
  `total_survey_completed` int(11) DEFAULT NULL,
  `total_social_post` int(11) DEFAULT NULL,
