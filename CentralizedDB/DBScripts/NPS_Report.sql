...
CREATE TABLE `nps_report_user_week` (
  ...
  `avg_nps` decimal(16,2) DEFAULT NULL,
  `promotors` int(11) DEFAULT NULL,
  `promotors_percentage` decimal(16,2) DEFAULT NULL,
  `detractors` int(11) DEFAULT NULL,
  `detractors_percentage` decimal(16,2) DEFAULT NULL,
  `passives` int(11) DEFAULT NULL,
  `passives_percentage` decimal(16,2) DEFAULT NULL,
