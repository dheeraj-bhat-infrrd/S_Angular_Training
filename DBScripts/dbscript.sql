...
CREATE TABLE `ss_user`.`verticals_master` (
  `VERTICALS_MASTER_ID` INT NOT NULL,
  ...
  --CREATE scripts : 02 FEB 2015 : Table for vertical-crm-mapping
  CREATE TABLE `verticals_crm_mapping` (
  `VERTICAL_MAPPING_ID` int(11) NOT NULL,
  `VERTICAL_ID` int(11) NOT NULL,
  `CRM_SOURCE` varchar(45) NOT NULL,
  `STATUS` INT(1) NOT NULL,
  `CREATED_ON` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `CREATED_BY` varchar(45) NOT NULL,
  `MODIFIED_ON` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `MODIFIED_BY` varchar(45) NOT NULL,
  PRIMARY KEY (`VERTICAL_MAPPING_ID`),
