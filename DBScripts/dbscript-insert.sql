...
INSERT INTO `ss_user`.`VERTICALS_MASTER` VALUES (-1,'CUSTOM',1,'2015-02-02 07:00:00','1','2015-02-02 07:00:00','1'),(1,'BANKING',1,'2015-02-02 07:00:00','1','2015-02-02 07:00:00','1'),(2,'MORTGAGE',1,'2015-02-02 07:00:00','1','2015-02-02 07:00:00','1'),(3,'REALTOR',1,'2015-02-02 07:00:00','1','2015-02-02 07:00:00','1');

-- Inserting default values into COMPANY
INSERT INTO `ss_user`.`COMPANY` (`COMPANY_ID`, `COMPANY`,`VERTICAL_ID`,`IS_REGISTRATION_COMPLETE`, `STATUS`, `CREATED_ON`, `CREATED_BY`, `MODIFIED_ON`, `MODIFIED_BY`) VALUES ('1', 'Default',-1, 1, '1', '2014-11-25 19:34:12', 'ADMIN', '2014-11-25 19:34:12', 'ADMIN');
