...
update ss_user.SURVEY_PRE_INITIATION set error_code = "CORRUPT_RECORD_AGENT_EMAIL_ID_NULL" where agent_emailid is null
	and status = 3;
	
update ss_user.SURVEY_PRE_INITIATION set error_code = "CORRUPT_RECORD_CUSTOMER_EMAIL_ID_NULL" where customer_email_id is null
	and status = 3;
	
update ss_user.SURVEY_PRE_INITIATION set error_code = "CORRUPT_RECORD_CUSTOMER_FIRST_NAME_NULL" where customer_first_name is null
	and status = 3;
