...
CREATE TABLE `branch` (
  ...
  `IS_DEFAULT_BY_SYSTEM` int(1) NOT NULL,
  `STATUS` int(1) NOT NULL,
  `CREATED_ON` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `CREATED_BY` varchar(45) NOT NULL,
  `MODIFIED_ON` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `region` (
  ...
  `COMPANY_ID` int(10) unsigned NOT NULL,
  `REGION` varchar(250) NOT NULL DEFAULT 'Region name',
  `IS_DEFAULT_BY_SYSTEM` int(1) NOT NULL,
  `STATUS` int(1) NOT NULL,
  `CREATED_ON` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `CREATED_BY` varchar(45) NOT NULL,
...
CREATE TABLE `survey_questions` (
  ...
  `SURVEY_QUESTIONS_CODE` varchar(10) NOT NULL,
...
CREATE TABLE `user_profile` (
  ...
  `USER_PROFILE_TYPE` varchar(3) DEFAULT NULL,
  `STATUS` int(1) NOT NULL,
  `CREATED_ON` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `CREATED_BY` varchar(45) NOT NULL,
  `MODIFIED_ON` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
-- Dump completed on 2014-11-18 14:19:18
