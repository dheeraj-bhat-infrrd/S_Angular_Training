...
public class EmailServicesImplTest
{
    ...
    public void sendSurveyCompletionMailToAdminsAndAgentTestRecipientMailIdNull()
        throws InvalidInputException, UndeliveredEmailException
    {
        emailServicesImpl.sendSurveyCompletionMailToAdminsAndAgent( null, null, null, "test", null, null, null );
    }
    ...
    public void sendSurveyCompletionMailToAdminsAndAgentTestSurveyEmpty()
        throws InvalidInputException, UndeliveredEmailException
    {
        emailServicesImpl.sendSurveyCompletionMailToAdminsAndAgent( "test", "test", "test", "", null, null, null );
    }
