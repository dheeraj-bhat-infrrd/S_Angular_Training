...
public class BillingReportsServiceImplTest
{
    @Spy
    @InjectMocks
    private BillingReportsServiceImpl billingReportsService;
    ...
    public void testIsUserAnAgentForAgent()
    {
        ...
        assertTrue( billingReportsService.isUserAnAgent( profileMasters ) );
    }
    ...
    {
        List<Long> profileMasters = new ArrayList<Long>();
        assertFalse( billingReportsService.isUserAnAgent( profileMasters ) );
    }
    ...
    public void testGetAddressFromAgent() throws InvalidInputException, NoRecordsFetchedException
    {
        ...
        assertEquals( "test", billingReportsService.getAddress( agentSettings, new BillingReportData(), "CA", "RA", "BA" ) );
    }
        ...
        NoRecordsFetchedException
    {
        ...
        assertEquals( "test", billingReportsService.getAddress( new AgentSettings(), reportRow, "CA", "RA", "BA" ) );
    }
        ...
        NoRecordsFetchedException
    {
        ...
        reportRow.setBranchId( 1l );
        Mockito.when( organizationManagementService.getBranchSettingsDefault( Mockito.anyLong() ) ).thenReturn( branchSettings );
        assertEquals( "test", billingReportsService.getAddress( new AgentSettings(), reportRow, "CA", "RA", null ) );
    }
    ...
    public void testGetAddressFromBranchForNonDefaultBranch() throws InvalidInputException, NoRecordsFetchedException
    {
        ...
        Mockito.when( organizationManagementService.getBranchSettingsDefault( Mockito.anyLong() ) ).thenReturn( branchSettings );
        assertEquals( "BA", billingReportsService.getAddress( new AgentSettings(), reportRow, "CA", "RA", "BA" ) );
    }
        ...
        NoRecordsFetchedException
    {
        ...
        Mockito.when( organizationManagementService.getBranchSettingsDefault( Mockito.anyLong() ) ).thenReturn(
            new OrganizationUnitSettings() );
        Mockito.when( organizationManagementService.getRegionSettings( Mockito.anyLong() ) ).thenReturn( regionSettings );
        assertEquals( "test", billingReportsService.getAddress( new AgentSettings(), reportRow, "CA", null, null ) );
    }
    ...
    public void testGetAddressFromRegionForDefaultBranchAndRegion() throws InvalidInputException, NoRecordsFetchedException
    {
        ...
        Mockito.when( organizationManagementService.getBranchSettingsDefault( Mockito.anyLong() ) ).thenReturn(
            new OrganizationUnitSettings() );
        Mockito.when( organizationManagementService.getRegionSettings( Mockito.anyLong() ) ).thenReturn( regionSettings );
        assertEquals( "RA", billingReportsService.getAddress( new AgentSettings(), reportRow, "CA", "RA", null ) );
    }
        ...
        NoRecordsFetchedException
    {
        ...
        Mockito.when( organizationManagementService.getCompanySettings( Mockito.anyLong() ) ).thenReturn( companySettings );
        assertEquals( "test", billingReportsService.getAddress( new AgentSettings(), reportRow, null, null, null ) );
    }
    ...
    public void testGetAddressFromCompany() throws InvalidInputException, NoRecordsFetchedException
    {
        ...
        reportRow.setCompanyId( 0l );
        Mockito.when( organizationManagementService.getCompanySettings( Mockito.anyLong() ) ).thenReturn( companySettings );
        assertEquals( "CA", billingReportsService.getAddress( new AgentSettings(), reportRow, "CA", null, null ) );
    }
    ...
    {
        billingReportsService.getAddressFromContactDetails( null );
    }
}
