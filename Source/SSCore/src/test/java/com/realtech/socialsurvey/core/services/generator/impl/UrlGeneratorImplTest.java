...
public class UrlGeneratorImplTest {
	...
	/**
	 * Tests if InvalidInputException is thrown correctly by generateUrl when parameter map is not
	 * given.
	 * 
	 * @throws InvalidInputException
	 */
	...
	/**
	 * Tests if decryptUrl() returns an non null Map of parameters when additional parameters exist
	 * in the url.
	 * 
	 * @throws InvalidInputException
	 * @throws InvalidUrlException
	...
	public void testDecryptUrlWithParameters() throws InvalidInputException, InvalidUrlException {
		Map<String, String> decryptedParameters = urlGenerator
				.decryptUrl("http://www.socialsurvey.com/?token=12345&q=8d0f69ecdc877159750932044ffb68762c7e1c869bc2aab6fd7b7dc9c8df673d&id=1123");
		assertEquals(decryptedParameters, params);
	}
