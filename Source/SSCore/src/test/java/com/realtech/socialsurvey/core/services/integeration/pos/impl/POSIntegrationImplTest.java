...
public class POSIntegrationImplTest
{
    ...
    {
        Mockito.when( surveyPreInitiationDao.getProcessedIds( Mockito.anyString(), new Timestamp( Mockito.anyLong() ) ) )
            .thenReturn( new ArrayList<EngagementProcessingStatus>() );
    ...
    @Test ( expected = InvalidInputException.class)
    public void testInsertSurveyPreInitiationRecordForNullAgentEmailId() throws InvalidInputException,
    ...
    @Test ( expected = InvalidInputException.class)
    public void testInsertSurveyPreInitiationRecordForEmptyAgentEmailId() throws InvalidInputException,
        AgentNotAvailableException
    {
    ...
    @Test ( expected = InvalidInputException.class)
    public void testInsertSurveyPreInitiationRecordForNullCustomerList() throws InvalidInputException,
        AgentNotAvailableException
    {
    ...
    @Test ( expected = InvalidInputException.class)
    public void testInsertSurveyPreInitiationRecordForEmptyCustomerList() throws InvalidInputException,
        AgentNotAvailableException
    {
        agent.setAgentEmailId( "test" );
    ...
    @Test
    public void testGetAgentIdAgentPresent()
    {
        assertEquals( "agent present", 2, posIntegrationImpl.getAgentId( TestConstants.TEST_MAIL_ID_STRING ) );
    }


    @Test
    public void testGetAgentIdAgentNotPresent()
    {
        assertEquals( "agent not present", -1, posIntegrationImpl.getAgentId( "nishit+none@raremile.com" ) );
    }
}
