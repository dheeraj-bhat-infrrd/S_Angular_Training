...
@Entity
@Table ( name = "overview_region")
//@NamedQuery ( name = "overview_region.findAll", query = "SELECT a FROM overview_region a")
public class OverviewRegion implements Serializable
{
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue ( strategy = GenerationType.IDENTITY)
    @Column ( name = "overview_region_id")
    private String overviewRegionId;
    ...
    public void setOverviewRegionId( String overviewRegionId )
    {
        this.overviewRegionId = overviewRegionId;
    }
    ...
    public String toString() {
        return "OverviewRegion [overviewRegionId=" + overviewRegionId + ", regionId=" + regionId + ", spsScore=" + spsScore + ", totalDetractors=" + totalDetractors
