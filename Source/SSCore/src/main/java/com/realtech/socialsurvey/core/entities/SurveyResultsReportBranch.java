 ...
 */
@Entity
@Table(name = "survey_results_report_branch")
public class SurveyResultsReportBranch implements Serializable {
	...
	@Column(name = "SURVEY_RESULTS_REPORT_BRANCH_ID")
	private String surveyResultsReportBranchId;
	...
	public void setSurveyResultsReportBranchId(String surveyResultsReportBranchId) {
		this.surveyResultsReportBranchId = surveyResultsReportBranchId;
	}
