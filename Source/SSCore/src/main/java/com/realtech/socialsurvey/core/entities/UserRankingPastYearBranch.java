...
@Entity
@Table(name= "user_ranking_past_year_branch")
public class UserRankingPastYearBranch
{
	private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue ( strategy = GenerationType.IDENTITY)
    @Column ( name = "user_ranking_past_year_branch_id")
    private String userRankingPastYearBranchId;
	...
	public String getUserRankingPastYearBranchId() {
		return userRankingPastYearBranchId;
	}

	public void setUserRankingPastYearBranchId(String userRankingPastYearBranchId) {
		this.userRankingPastYearBranchId = userRankingPastYearBranchId;
	}
	...
	public String toString() {
		return "UserRankingPastYearBranch [userRankingPastYearBranchId=" + userRankingPastYearBranchId + ", userId="
				+ userId + ", companyId=" + companyId + ", branchId=" + branchId + ", year=" + year + ", firstName="
				+ firstName + ", lastName=" + lastName + ", rankingScore=" + rankingScore + ", rank=" + rank + ", sps="
