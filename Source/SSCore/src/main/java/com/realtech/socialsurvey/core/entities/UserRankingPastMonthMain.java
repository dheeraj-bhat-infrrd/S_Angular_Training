...
@Entity
@Table(name= "user_ranking_past_month_main")
public class UserRankingPastMonthMain
{
    ...
    @Column ( name = "user_ranking_past_month_main_id")
    private String userRankingPastMonthMainId;
	...
	public String getUserRankingPastMonthMainId() {
		return userRankingPastMonthMainId;
	}


	public void setUserRankingPastMonthMainId(String userRankingPastMonthMainId) {
		this.userRankingPastMonthMainId = userRankingPastMonthMainId;
	}
	...
	public String toString() {
		return "UserRankingPastMonthMain [userRankingPastMonthMainId=" + userRankingPastMonthMainId + ", userId="
				+ userId + ", companyId=" + companyId + ", month=" + month + ", year=" + year + ", firstName="
