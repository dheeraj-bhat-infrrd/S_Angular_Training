...
public class SurveyHandlerImpl implements SurveyHandler, InitializingBean {
	...
	public void sendSurveyInvitationMail(String custFirstName, String custLastName, String custEmail, String custRelationWithAgent, User user,
			boolean isAgent, String source) throws InvalidInputException, SolrException, NoRecordsFetchedException, UndeliveredEmailException, ProfileNotFoundException {
	...
	public void sendSurveyRestartMail(String custFirstName, String custLastName, String custEmail, String custRelationWithAgent, User user,
			String surveyUrl) throws InvalidInputException, UndeliveredEmailException, ProfileNotFoundException {
		...
		if (companySettings != null && companySettings.getMail_content() != null
			...
			emailServices.sendDefaultSurveyInvitationMail(custEmail, emailFormatHelper.getCustomerDisplayNameForEmail(custFirstName, custLastName),
					user.getFirstName() + (user.getLastName() != null ? " " + user.getLastName() : ""), surveyUrl, user.getEmailId(), agentSignature,
	 ...
	 */
	private void sendInvitationMailByAgent(User user, String custFirstName, String custLastName, String custEmail, String surveyUrl, String logoUrl)
	...
	private void sendInvitationMailByCustomer(User user, String custFirstName, String custLastName, String custEmail, String link)
		...
		if (companySettings != null && companySettings.getMail_content() != null
			...
			emailServices.sendDefaultSurveyInvitationMailByCustomer(custEmail, custFirstName, user.getFirstName()
	...
	private void preInitiateSurvey(User user, String custEmail, String custFirstName, String custLastName, int i, String custRelationWithAgent,
			String source) {
	...
	@Override
	@Transactional
	public void initiateSurveyRequest(long agentId, String recipientEmailId, String recipientFirstname, String recipientLastname, String source)
			throws DuplicateSurveyRequestException, InvalidInputException, SelfSurveyInitiationException, SolrException, NoRecordsFetchedException, UndeliveredEmailException, ProfileNotFoundException {
		LOG.info("Sending survey request for agent id: " + agentId + " recipientEmailId: " + recipientEmailId + " recipientFirstname: "
		...
		if (recipientEmailId == null || recipientEmailId.isEmpty() || !recipientEmailId.trim().matches(CommonConstants.EMAIL_REGEX)) {
			LOG.warn("Recipent email id should be passed.");
			throw new InvalidInputException("Recipent email id is invalid");
		}
		if((recipientFirstname == null || recipientFirstname.isEmpty()) && (recipientLastname == null || recipientLastname.isEmpty())){
		...
		List<SurveyPreInitiation> incompleteSurveyCustomers = surveyPreInitiationDao.findByKeyValue(SurveyPreInitiation.class, queries);
