...
@Entity
@Table ( name = "overview_user_month")
public class OverviewUserMonth implements Serializable
{
    ...
    @Column ( name = "overview_user_month_id")
    private String overviewUserMonthId;
    ...
    {
        return overviewUserMonthId;
    }

    public void setOverviewUserMonthId( String overviewUserMonthId )
    {
        this.overviewUserMonthId = overviewUserMonthId;
    }
    ...
    {
        return "OverviewUserMonth [overviewUserMonthId=" + overviewUserMonthId + ", userId=" + userId + ", processed="
            ...
            + unsubscribed + ", google=" + google + ", facebook=" + facebook + "]";
    }
