...
@Entity
@Table ( name = "overview_region_month")
public class OverviewRegionMonth implements Serializable
{
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue ( strategy = GenerationType.IDENTITY)
    @Column ( name = "overview_region_month_id")
    private String overviewRegionMonthId;
    ...
    {
        return overviewRegionMonthId;
    }


    public void setOverviewRegionMonthId( String overviewRegionMonthId )
    {
        this.overviewRegionMonthId = overviewRegionMonthId;
    }
    ...
    {
        return "OverviewRegionMonth [overviewRegionMonthId=" + overviewRegionMonthId + ", regionId=" + regionId + ", processed="
