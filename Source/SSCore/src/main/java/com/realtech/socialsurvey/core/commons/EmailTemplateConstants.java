...
/**
 * Class with constants containing file names of email templates used in the application
 */
public final class EmailTemplateConstants {
    ...
    public static final String EMAIL_VERIFIED_NOTIFICATION_MAIL_BODY = "EmailVerifiedNotificationMailBody.html";
    public static final String EMAIL_VERIFIED_NOTIFICATION_MAIL_SUBJECT = "EmailVerifiedNotificationMailSubject.txt";
    
    public static final String EMAIL_VERIFIED_NOTIFICATION_MAIL_TO_ADMIN_BODY = "EmailVerifiedNotificationMailToAdminBody.html";
    public static final String EMAIL_VERIFIED_NOTIFICATION_MAIL_TO_ADMIN_SUBJECT = "EmailVerifiedNotificationMailToAdminSubject.txt";
	...
	public static final String SURVEY_COMPLETION_ADMINS_MAIL_BODY_NEW = "SurveyCompletionAdminsMailBodyNew.html";
    ...
    public static final String REPORT_EXCEPTION_IN_BATCH_TO_ADMIN_SUBJECT = "ReportExceptionINBatchToAdminSubject.txt";
    public static final String REPORT_EXCEPTION_IN_BATCH_TO_ADMIN_BODY = "ReportExceptionINBatchToAdminMailBody.html";
	...
	public static final String NEW_REGISTRATION_MAIL_SUBJECT = "NewRegistrationMailSubject.txt";
