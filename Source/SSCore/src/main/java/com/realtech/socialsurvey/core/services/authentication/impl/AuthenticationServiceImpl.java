...
public class AuthenticationServiceImpl implements AuthenticationService
{
     ...
     */
    @Override
    public void sendResetPasswordLink( String emailId, String name, long companyId, String loginName )
    ...
    public UserProfile getCompanyAdminProfileForUser( User user ) throws InvalidInputException
    {
        ...
        ProfilesMaster profilesMaster = userManagementService
            .getProfilesMasterById( CommonConstants.PROFILES_MASTER_COMPANY_ADMIN_PROFILE_ID );
    ...
    @Override
    @Transactional
    public User getActiveOrIncompleteUserWithLoginName( String userName ) throws NoRecordsFetchedException
    {
        LOG.info( "Fetching user object with userId : " + userName );
        User user = userDao.getActiveOrIncompleteUser( userName );
        if ( user == null ) {
            throw new NoRecordsFetchedException( "No user found with userName : " + userName );
        }
        userManagementService.setProfilesOfUser( user );
