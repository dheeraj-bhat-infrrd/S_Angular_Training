 ...
 */
@Entity
@Table(name = "user_ranking_report_branch_year")
public class BranchRankingReportYear {
	
	@Id
	@Column(name = "user_ranking_report_branch_year_id")
	String id;
	...
	public String toString() {
		return "BranchRankingReportYear [id=" + id + ", rankInCompany=" + rankInCompany + ", branchId=" + branchId
				...
				+ ", isEligible=" + isEligible + ", year=" + year + "]";
	}
}