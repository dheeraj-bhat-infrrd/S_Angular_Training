...
public class UserManagementServiceImpl implements UserManagementService, InitializingBean {
	...
	public List<ProListUser> getMultipleUsersByUserId(List<Long> userIds) throws InvalidInputException {
		...
		for (AgentSettings agentSettings : agentSettingsList) {
			...
			user.setReviewScore(surveyDetailsDao.getRatingForPastNdays(CommonConstants.AGENT_ID, agentSettings.getIden(), CommonConstants.NO_LIMIT,
					true, false));
			users.add(user);
		}
	 ...
	 */
	private void inviteUser(String url, String emailId, String firstName, String lastName, boolean isReinvitation) throws UserAlreadyExistsException,
	...
	@Override
	@Transactional(rollbackFor = { NonFatalException.class, FatalException.class })
	public User inviteUser(User admin, String firstName, String lastName, String emailId) throws InvalidInputException, UserAlreadyExistsException,
			UndeliveredEmailException, SolrException {
	...
	@Override
	@Transactional(rollbackFor = { NonFatalException.class, FatalException.class })
	public User addCorporateAdmin(String firstName, String lastName, String emailId, String confirmPassword, boolean isDirectRegistration)
