...
@Entity
@Table ( name = "overview_company")
//@NamedQuery ( name = "overview_company.findAll", query = "SELECT a FROM overview_company a")
public class OverviewCompany implements Serializable
{
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue ( strategy = GenerationType.IDENTITY)
    @Column ( name = "overview_company_id")
    private String overviewCompanyId;
    ...
    public void setOverviewCompanyId( String overviewRegionId )
    {
        this.overviewCompanyId = overviewRegionId;
    }
    ...
    public void setCompanyId( int regionId )
    {
        this.companyId = regionId;
    }
