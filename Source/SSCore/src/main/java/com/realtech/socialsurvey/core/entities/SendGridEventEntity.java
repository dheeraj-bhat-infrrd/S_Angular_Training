...
/**
 * Created by lavanya on 13/12/17.
 */

/**
 * Entity for sending email click tracking event
 */
public class SendGridEventEntity implements Serializable {
    ...
    public String toString() {
        return "SendgridEvent [email=" + email + ", timestamp=" + timestamp + ", smtpId=" + smtpId + ", event=" + event
                + ", category=" + category + ", sgEventId=" + sgEventId + ", sgMessageId=" + sgMessageId
                + ", response=" + response + ", attempt=" + attempt + ", useragent=" + useragent + ", ip=" + ip
                + ", url=" + url + ", reason=" + reason + ", status=" + status + ", asmGroupId=" + asmGroupId
                + ", uuid=" + uuid + "]";
    }
}
