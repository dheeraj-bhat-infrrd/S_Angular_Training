...
/**
 * This is the base Dao which needs to be extended by each ReportingDao. It contains implementation for reporting
 * CRUD methods required by every Dao.
 */
/*@Primary
@Component ( "genericReporting")
public class GenericReportingDaoImpl<T, ID extends Serializable> implements GenericDao<T, ID>
{

        private static final Logger LOG = LoggerFactory.getLogger( GenericDaoImpl.class );
        private Class<T> persistentClass;
        @Autowired
        @Qualifier(value = "sessionFactoryForReporting")
