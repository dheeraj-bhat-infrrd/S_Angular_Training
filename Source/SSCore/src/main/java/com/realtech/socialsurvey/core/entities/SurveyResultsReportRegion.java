...
public class SurveyResultsReportRegion implements Serializable {
	...
	public String toString() {
		return "SurveyResultsReportRegion [surveyResultsReportRegionId=" + surveyResultsReportRegionId
				+ ", surveyDetailsId=" + surveyDetailsId + ", regionId=" + regionId + ", agentId=" + agentId
