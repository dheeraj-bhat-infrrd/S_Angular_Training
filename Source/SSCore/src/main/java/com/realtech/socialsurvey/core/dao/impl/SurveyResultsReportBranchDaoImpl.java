...
public class SurveyResultsReportBranchDaoImpl extends GenericReportingDaoImpl<SurveyResultsReportBranch, String>
	 ...
	 * not missed
	 */
	private static final String getSurveyResultAllTImeByBranchIdQuery = "select ab.SURVEY_DETAILS_ID,sr.answer,ab.USER_FIRST_NAME,ab.USER_LAST_NAME,ab.CUSTOMER_FIRST_NAME,ab.CUSTOMER_LAST_NAME,ab.SURVEY_SENT_DATE,"
	...
	public Map<String, SurveyResultsReportBranch> getSurveyResultForBranchId(long branchId, Timestamp startDate,
		...
		try {
			if (startDate != null && endDate != null) {
				...
				query = getSession().createSQLQuery(getSurveyResultAllTImeByBranchIdQuery);
