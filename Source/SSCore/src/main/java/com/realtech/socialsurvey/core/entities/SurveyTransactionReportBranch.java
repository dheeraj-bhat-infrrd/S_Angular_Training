...
@Entity
@Table(name= "survey_transaction_report_branch")
public class SurveyTransactionReportBranch
{
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue ( strategy = GenerationType.IDENTITY)
    @Column ( name = "survey_transaction_report_branch_id")
    private String surveyTransactionReportBranchId;
    ...
    {
        return surveyTransactionReportBranchId;
    }

    public void setSurveyTransactionReportBranchId( String surveyTransactionReportBranchId )
    {
        this.surveyTransactionReportBranchId = surveyTransactionReportBranchId;
    }
