...
public class UserRankingThisMonthBranch
{
    ...
    @Column ( name = "user_ranking_this_month_branch_id")
    private String userRankingThisMonthBranchId;
	...
	public String getUserRankingThisMonthBranchId() {
		return userRankingThisMonthBranchId;
	}

	public void setUserRankingThisMonthBranchId(String userRankingThisMonthBranchId) {
		this.userRankingThisMonthBranchId = userRankingThisMonthBranchId;
	}
	...
	public String toString() {
		return "UserRankingThisMonthBranch [userRankingThisMonthBranchId=" + userRankingThisMonthBranchId + ", userId="
				+ userId + ", companyId=" + companyId + ", branchId=" + branchId + ", thisMonth=" + thisMonth
				+ ", thisYear=" + thisYear + ", firstName=" + firstName + ", lastName=" + lastName + ", rankingScore="
