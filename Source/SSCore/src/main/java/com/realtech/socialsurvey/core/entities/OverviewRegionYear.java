...
@Entity
@Table ( name = "overview_region_year")
public class OverviewRegionYear implements Serializable
{
    ...
    @Column ( name = "overview_region_year_id")
    private String overviewRegionYearId;
    ...
    public void setOverviewRegionYearId( String overviewRegionYearId )
    {
        this.overviewRegionYearId = overviewRegionYearId;
    }
    ...
    {
        return "OverviewRegionYear [overviewRegionYearId=" + overviewRegionYearId + ", regionId=" + regionId + ", processed="
