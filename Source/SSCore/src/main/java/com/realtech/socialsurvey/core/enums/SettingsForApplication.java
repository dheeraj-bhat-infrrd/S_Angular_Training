...
public enum SettingsForApplication {
	...
	LOGO(1l, 1), ADDRESS(10l, 2), PHONE(100l, 3), LOCATION(1000l, 4), FACEBOOK(10000l, 5), TWITTER(100000l, 6), LINKED_IN(1000000l, 7), GOOGLE_PLUS(
			10000000l, 8), YELP(100000000l, 9), ZILLOW(1000000000l, 10), REALTOR(10000000000l, 11), LENDING_TREE(100000000000l, 12),WEB_ADDRESS_WORK(1000000000000l, 13),WEB_ADDRESS_BLOG(10000000000000l, 14),WEB_ADDRESS_PERSONAL(100000000000000l, 15),ABOUT_ME(1000000000000000l, 16), EMAIL_ID_PERSONAL(10000000000000000l, 17), EMAIL_ID_WORK(100000000000000000l, 18);
