...
@Entity
@Table(name= "user_ranking_this_month_main")
public class UserRankingThisMonthMain
{
    ...
    @Column ( name = "user_ranking_this_month_main_id")
    private String userRankingThisMonthMainId;
	...
	public String getUserRankingThisMonthMainId() {
		return userRankingThisMonthMainId;
	}

	public void setUserRankingThisMonthMainId(String userRankingThisMonthMainId) {
		this.userRankingThisMonthMainId = userRankingThisMonthMainId;
	}
    ...
    {
        return "UserRankingThisMonthMain [userRankingThisMonthMainId=" + userRankingThisMonthMainId + ", userId=" + userId
            ...
            + isEligible + ", nmlsId=" + nmlsId + ", profileImageUrlThumbnail=" + profileImageUrlThumbnail + "]";
    }
}
