...
public class SocialMediaTokensPaginated implements Serializable
{
    ...
    public String toString()
    {
        return "SocialMediaTokensPaginated [companiesTokens=" + companiesTokens + ", regionsTokens=" + regionsTokens
            + ", branchesTokens=" + branchesTokens + ", agentsTokens=" + agentsTokens + ", totalRecord=" + totalRecord
            + ", regionCompanyIdMap=" + regionCompanyIdMap + ", branchCompanyIdMap=" + branchCompanyIdMap
            + ", agentCompanyIdMap=" + agentCompanyIdMap + "]";
    }
}
