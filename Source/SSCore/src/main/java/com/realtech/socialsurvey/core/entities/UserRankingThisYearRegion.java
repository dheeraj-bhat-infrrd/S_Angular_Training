...
public class UserRankingThisYearRegion
{
	private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue ( strategy = GenerationType.IDENTITY)
    @Column ( name = "user_ranking_this_year_region_id")
    private String userRankingThisYearRegionId;
	...
	public String getUserRankingThisYearRegionId() {
		return userRankingThisYearRegionId;
	}

	public void setUserRankingThisYearRegionId(String userRankingThisYearRegionId) {
		this.userRankingThisYearRegionId = userRankingThisYearRegionId;
	}
	...
	public String toString() {
		return "UserRankingThisYearRegion [userRankingThisYearRegionId=" + userRankingThisYearRegionId + ", userId="
				+ userId + ", companyId=" + companyId + ", regionId=" + regionId + ", thisYear=" + thisYear
