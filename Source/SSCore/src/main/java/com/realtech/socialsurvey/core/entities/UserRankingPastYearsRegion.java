...
public class UserRankingPastYearsRegion
{
    ...
    @Column ( name = "user_ranking_past_years_region_id")
    private String userRankingPastYearsRegionId;
    ...
    {
        return userRankingPastYearsRegionId;
    }

    public void setUserRankingPastYearsRegionId( String userRankingPastYearsRegionId )
    {
        this.userRankingPastYearsRegionId = userRankingPastYearsRegionId;
    }
