...
@Entity
@Table(name= "user_ranking_past_year_main")
public class UserRankingPastYearMain
{
	private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue ( strategy = GenerationType.IDENTITY)
    @Column ( name = "user_ranking_past_year_main_id")
    private String userRankingPastYearMainId;
	...
	public String getUserRankingPastYearMainId() {
		return userRankingPastYearMainId;
	}

	public void setUserRankingPastYearMainId(String userRankingPastYearMainId) {
		this.userRankingPastYearMainId = userRankingPastYearMainId;
	}
	...
	public String toString() {
		return "UserRankingPastYearMain [userRankingPastYearMainId=" + userRankingPastYearMainId + ", userId=" + userId
				+ ", companyId=" + companyId + ", year=" + year + ", firstName=" + firstName + ", lastName=" + lastName
				...
				+ completedPercentage + ", totalReviews=" + totalReviews + ", averageRating=" + averageRating
