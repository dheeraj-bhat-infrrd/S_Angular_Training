...
public class EmailServicesImpl implements EmailServices
{
    ...
    public void sendSurveyCompletionMail( String recipientMailId, String displayName, String agentName, String agentEmail,
        String agentProfileName ) throws InvalidInputException, UndeliveredEmailException
    {
        if ( recipientMailId == null || recipientMailId.isEmpty() ) {
            LOG.error( "Recipient email Id is empty or null for sending survey completion mail " );
            throw new InvalidInputException( "Recipient email Id is empty or null for sending survey completion mail " );
    ...
    @Async
    @Override
    public void sendDefaultSurveyReminderMail( String recipientMailId, String firstName, String agentName, String agentEmailId,
    ...
    public void sendSocialPostReminderMail( String recipientMailId, String agentPhone, String agentTitle, String companyName,
        String displayName, String agentName, String links ) throws InvalidInputException, UndeliveredEmailException
    {
        if ( recipientMailId == null || recipientMailId.isEmpty() ) {
            LOG.error( "Recipient email Id is empty or null for sending survey completion mail " );
            throw new InvalidInputException( "Recipient email Id is empty or null for sending survey completion mail " );
    ...
    @Async
    @Override
    public void sendDefaultSurveyRestartMail( String recipientMailId, String displayName, String agentName, String link,
        ...
        String surveyLink )
    {
        ...
        if ( companySettings != null && companySettings.getMail_content() != null
            ...
            try {
                sendDefaultSurveyReminderMail( survey.getCustomerEmailId(), survey.getCustomerFirstName(), agentName,
