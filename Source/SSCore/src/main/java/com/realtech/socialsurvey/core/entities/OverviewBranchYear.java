...
@Entity
@Table ( name = "overview_branch_year")
public class OverviewBranchYear implements Serializable
{
    ...
    @Column ( name = "overview_branch_year_id")
    private String overviewBranchYearId;
    ...
    public String getOverviewBranchYearId()
    {
        return overviewBranchYearId;
    }

    public void setOverviewBranchYearId( String overviewBranchYearId )
    {
        this.overviewBranchYearId = overviewBranchYearId;
    }
    ...
    {
        return "OverviewBranchYear [overviewBranchYearId=" + overviewBranchYearId + ", branchId=" + branchId + ", processed="
