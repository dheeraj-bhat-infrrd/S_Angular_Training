...
public class UserRankingPastMonthBranch
{
	...
	public String toString() {
		return "UserRankingPastMonthBranch [userRankingPastMonthBranchId=" + userRankingPastMonthBranchId + ", userId="
				+ userId + ", companyId=" + companyId + ", branchId=" + branchId + ", month=" + month + ", year=" + year
				...
				+ ", averageRating=" + averageRating + ", isEligible=" + isEligible + ", internalBranchRank="
				+ internalBranchRank + "]";
	}
