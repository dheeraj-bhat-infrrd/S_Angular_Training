...
public class SolrSearchServiceImpl implements SolrSearchService {
	 ...
	 * "http://localhost:8983/solr/ss-users/"; Company company = new Company();
	 * company.setCompanyId(2); User user = new User(); try { user.setUserId(11);
	 * System.out.println(solrSearchServiceImpl.searchUsersByLoginNameOrName("ritwik")); } catch
	 * (InvalidInputException | SolrException e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } }
	 */
}