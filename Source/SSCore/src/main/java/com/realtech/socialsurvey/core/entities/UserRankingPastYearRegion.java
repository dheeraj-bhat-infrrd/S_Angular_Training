...
public class UserRankingPastYearRegion
{
    ...
    {
        return "UserRankingPastYearRegion [userRankingPastYearRegionId=" + userRankingPastYearRegionId + ", userId=" + userId
            + ", companyId=" + companyId + ", regionId=" + regionId + ", branchId=" + branchId + ", year=" + year
