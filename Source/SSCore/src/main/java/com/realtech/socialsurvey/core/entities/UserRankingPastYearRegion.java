...
@Entity
@Table(name= "user_ranking_past_year_region")
public class UserRankingPastYearRegion
{
	private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue ( strategy = GenerationType.IDENTITY)
    @Column ( name = "user_ranking_past_year_region_id")
    private String userRankingPastYearRegionId;
	...
	public String getUserRankingPastYearRegionId() {
		return userRankingPastYearRegionId;
	}

	public void setUserRankingPastYearRegionId(String userRankingPastYearRegionId) {
		this.userRankingPastYearRegionId = userRankingPastYearRegionId;
	}
	...
	public String toString() {
		return "UserRankingPastYearRegion [userRankingPastYearRegionId=" + userRankingPastYearRegionId + ", userId="
				+ userId + ", companyId=" + companyId + ", regionId=" + regionId + ", year=" + year + ", firstName="
