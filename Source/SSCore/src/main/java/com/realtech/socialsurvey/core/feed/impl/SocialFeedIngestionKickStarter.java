...
public class SocialFeedIngestionKickStarter {
	 ...
	 */
	private void startFeedIngestion(String collectionName) {
	...
	private void fetchFeedFromIndividualSocialMediaTokens(FeedIngestionEntity ingestionEntity, String collectionName) {
