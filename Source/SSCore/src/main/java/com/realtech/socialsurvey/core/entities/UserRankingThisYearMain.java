...
@Entity
@Table(name= "user_ranking_this_year_main")
public class UserRankingThisYearMain
{
    ...
    @Column ( name = "user_ranking_this_year_main_id")
    private String userRankingThisYearMainId;
	...
	public String getUserRankingThisYearMainId() {
		return userRankingThisYearMainId;
	}

	public void setUserRankingThisYearMainId(String userRankingThisYearMainId) {
		this.userRankingThisYearMainId = userRankingThisYearMainId;
	}
