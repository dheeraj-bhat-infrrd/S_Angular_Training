...
public class SettingsLockerImpl implements SettingsLocker {
	...
	public Company lockSettingsValueForCompany(Company company, SettingsForApplication settings, boolean hasBeenLocked) throws NonFatalException {
		...
		double modifiedSettingsLockValue = getModifiedSetSettingsValue(OrganizationUnit.COMPANY, Long.parseLong(company.getSettingsLockStatus()),
	...
	public Region lockSettingsValueForRegion(Region region, SettingsForApplication settings, boolean hasBeenLocked) throws NonFatalException {
		...
		double modifiedSettingsLockValue = getModifiedSetSettingsValue(OrganizationUnit.REGION, Long.parseLong(region.getSettingsLockStatus()),
				settings, hasBeenLocked);
	...
	public Branch lockSettingsValueForBranch(Branch branch, SettingsForApplication settings, boolean hasBeenLocked) throws NonFatalException {
		...
		double modifiedSettingsLockValue = getModifiedSetSettingsValue(OrganizationUnit.BRANCH, Long.parseLong(branch.getSettingsLockStatus()),
				settings, hasBeenLocked);
	...
	double getModifiedSetSettingsValue(OrganizationUnit organizationUnit, long currentLockValue, SettingsForApplication settings,
