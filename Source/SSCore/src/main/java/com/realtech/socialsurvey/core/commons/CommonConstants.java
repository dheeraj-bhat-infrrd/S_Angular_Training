...
public interface CommonConstants
{
    ...
    public static final String BATCH_TYPE_UPDATE_VISIBILITY_OF_ALL_USERS_IN_SOLR = "updateVisibilityInSolr";
    ...
    public static final String BATCH_NAME_UPDATE_VISIBILITY_OF_ALL_USERS_IN_SOLR = "hide Users From Search By Adding a field in user schema";
