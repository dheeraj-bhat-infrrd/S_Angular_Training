...
public class SurveyDetailsVO
{
    ...
    {
        return "SurveyDetailsVO{" + "agentId=" + agentId + ", companyId=" + companyId + ", regionId=" + regionId + ", branchId="
            + branchId + ", agentName='" + agentName + '\'' + ", completeProfileUrl='" + completeProfileUrl + '\''
            + ", customerFirstName='" + customerFirstName + '\'' + ", customerLastName='" + customerLastName + '\''
            + ", source='" + source + '\'' + ", sourceId='" + sourceId + '\'' + ", review='" + review + '\'' + ", summary='"
            + summary + '\'' + ", score=" + score + ", surveyTransactionDate=" + surveyTransactionDate + ", stage=" + stage
            + ", agreedToShare='" + agreedToShare + '\'' + ", surveySentDate=" + surveySentDate + ", surveyCompletedDate="
            + surveyCompletedDate + ", createdOn=" + createdOn + ", modifiedOn=" + modifiedOn + ", surveyUpdatedDate="
            + surveyUpdatedDate + ", regionName='" + regionName + '\'' + ", branchName='" + branchName + '\''
            + ", profileType='" + profileType + '\'' + ", fbRecommendationType='" + fbRecommendationType + '\'' + '}';
    }
