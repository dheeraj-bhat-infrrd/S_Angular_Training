...
module.exports = {
  number: require('card-number'),
  expirationDate: require('expiration-date'),
  expirationMonth: require('expiration-month'),
  expirationYear: require('expiration-year'),
  cvv: require('cvv'),
  postalCode: require('postal-code')
};

},{"card-number":29,"cvv":30,"expiration-date":31,"expiration-month":32,"expiration-year":33,"postal-code":36}],2:[function(require,module,exports){
'use strict';
