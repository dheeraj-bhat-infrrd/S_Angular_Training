var widgetFramework = '<div id="ss-widget-container" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 widget-pad-zero">' + '<div id="ss-widget-dash" class="hide" ></div>' + '<div id="ss-widget-options" class="col-lg-5 col-md-5 col-sm-6 col-xs-12 widget-left-pad-zero widget-right-pad-zero">' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rating-btn-cont">' + '<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">' + '<div id="ss-widget-rating" class="ss-widget-rating">0</div>' + '<div id="ss-widget-rating-stars" class="ss-widget-rating-stars">' + '<div class="ss-widget-star-box">' + '<div class="ss-widget-star1 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-star2 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-star3 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-star4 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-star5 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '</div>' + '</div>' + '<div id="ss-widget-rev-count" class="ss-widget-rev-count">0 Reviews</div>' + '</div>' + '<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">' + '<div id="widget-contact-us-btn" class="widget-btns widget-contact-us-btn" data-link="">CONTACT US</div>' + '<div id="widget-write-rev-btn" class="widget-btns" data-link="">WRITE A REVIEW</div>' + '</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 widget-pad-zero ss-widget-rating-detils-container">' + '<div id="ss-widget-rating-details" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rating-details">' + 'Rating Details <span class="float-right" style="font-size:  13px;">&#9662;</span>' + '</div>' + '<div id="ss-widget-rating-cont" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rating-cont">' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero ss-widget-stars widget-star-blue">&#9733; &#9733; &#9733; &#9733; &#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero">' + '<div id="ss-widget-5star-bar" class="ss-widget-rating-bar widget-blue-bar"></div>' + '</div>' + '<div id="ss-widget-5star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc">0%</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero ss-widget-stars widget-star-green">&#9733; &#9733; &#9733; &#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero">' + '<div id="ss-widget-4star-bar" class="ss-widget-rating-bar widget-green-bar"></div>' + '</div>' + '<div id="ss-widget-4star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc">0%</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero ss-widget-stars widget-star-yellow">&#9733; &#9733; &#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero">' + '<div id="ss-widget-3star-bar" class="ss-widget-rating-bar widget-yellow-bar"></div>' + '</div>' + '<div id="ss-widget-3star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc">0%</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero ss-widget-stars widget-star-orange">&#9733; &#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero">' + '<div id="ss-widget-2star-bar" class="ss-widget-rating-bar widget-orange-bar"></div>' + '</div>' + '<div id="ss-widget-2star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc">0%</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero ss-widget-stars widget-star-red">&#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero">' + '<div id="ss-widget-1star-bar" class="ss-widget-rating-bar widget-red-bar"></div>' + '</div>' + '<div id="ss-widget-1star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc">0%</div>' + '</div>' + '</div>' + '</div>' + '<div id="ss-widget-opt" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-opt-cont">' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-opt-text">Options<span id="ss-widget-options-arrow" class="float-right cursor-pointer hide" style="font-size:  13px;">&#9662;</span></div>' + '<div id="ss-widget-options-dropdown" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-options-dropdown">' + '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ss-widget-opt">' + '<div class="w-100 ss-widget-opt-head-text">Filter Source</div>' + '<div>' + '<input type="checkbox" id="widget-opt-all" name="filterSource" value="all" checked />' + '<label for="scales">All</label>' + '</div>' + '<div>' + '<input type="checkbox" id="widget-opt-ss" name="filterSource" value="ss" checked />' + '<label for="scales">SocialSurvey</label>' + '</div>' + '<div>' + '<input type="checkbox" id="widget-opt-ssv" name="filterSource" value="ssv" checked />' + '<label for="scales">SocialSurvey Verified</label>' + '</div>'
/*
 * + '<div>' + '<input type="checkbox" id="widget-opt-goo" name="filterSource" value="google" checked />' + '<label for="scales">Google</label>' + '</div>'
 */
+ '<div>' + '<input type="checkbox" id="widget-opt-zil" name="filterSource" value="zillow" checked />' + '<label for="scales">Zillow</label>' + '</div>'
/*
 * + '<div>' + '<input type="checkbox" id="widget-opt-fb" name="filterSource" value="fb" checked />' + '<label for="scales">Facebook</label>' + '</div>' + '<div>' + '<input type="checkbox" id="widget-opt-lin" name="filterSource" value="linkedin" checked />' + '<label for="scales">LinkedIn</label>' + '</div>'
 */
+ '</div>' + '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ss-widget-order-cont">' + '<div id="ss-widget-order-data" class="w-100 ss-widget-opt-head-text" data-order="">Order By</div>' + '<div id="ss-widget-newest" class="w-100 ss-widget-order-text" data-order=1>Newest First</div>' + '<div id="ss-widget-oldest" class="w-100 ss-widget-order-text" data-order=2>Oldest First</div>' + '<div id="ss-widget-highest" class="w-100 ss-widget-order-text" data-order=3>Highest Rating</div>' + '<div id="ss-widget-lowest" class="w-100 ss-widget-order-text" data-order=4>Lowest Rating</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '<div id="ss-widget-reviews" class="col-lg-7 col-md-7 col-sm-6 col-xs-12 ss-widget-rev-cont">' + '<div class="w-100 ss-widget-rev-head">Reviews <span id="ss-widget-rev-options" class="float-right cursor-pointer">Options &#9662;</span></div>' + '<div id="ss-widget-review-div" class="w-100" data-allReviews=[] data-zillow=[] data-initialRev=1 data-maxLoadRev=1 data-startIndex=0 data-batchSize=1 data-index=0 data-nextBatchIndex=0 data-widgetDetails></div>' + '<div id="ss-widget-load-more-cont" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">' + '<div id="ss-widget-load-more-btn" class="ss-widget-load-more-btn">Load More</div>' + '</div>' + '<div id="ss-widget-modest-branding" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-powered-by hide">' + 'Powered by <span class="ss-widget-text-bold">SocialSurvey</span>' + '</div>' + '</div>' + '</div>';

var widgetReviewTemplate = '<div id="ss-widget-review-container" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev hide" data-index=0>' + '<div class="w-100">' + '<div class="float-left ss-widget-rev-date"></div>' + '<div class="float-right ss-widget-prov-by ss-widget-pow-by">provided by <div class="ss-widget-verified-badge ss-wi-verified-badge  ss-wi-verify-image ss-wi-zillow-badge  ss-wi-verify-image-zillow ss-wi-unverified-badge  ss-wi-verify-image-ss float-right" ></div></div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-details">' + '<div class="ss-widget-prof-pic-cont"><img src="/resources/images/image_pt.png" class="ss-widget-prof-pic"></div>' + '<div class="ss-widget-rev-prof-details">' + '<div class="ss-widget-prov-by">In reference to a transaction with</div>' + '<div class="ss-widget-rev-prof-name"></div>' + '<div class="ss-widget-rev-prof-title"> | NMLS# </div>' + '</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-stars">' + '<div class="ss-widget-star1 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-star2 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-star3 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-star4 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-star5 ss-widget-star-container"><div class="widget-black-star hide">&#9733;</div><div class="widget-white-star">&#9734;</div></div>' + '<div class="ss-widget-rev-score">0.0</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-cust-name">Stacey M <span class="ss-widget-rev-cust-addr">- Los Angeles, CA</span></div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-text-cont">' + '<div class="ss-widget-rev-text-quote">&#10075;</div>' + '<div class="ss-widget-rev-text-quote">&#10075;</div>' + '<div class="ss-widget-rev-text">' + '<p class="ss-widget-review-text">Sample</p>' + '<p class="ss-widget-text-bold ss-widget-read-more cursor-pointer">... read more</p>' + '</div>' + '</div>' + '</div>';

var urlPrefix = "http://localhost:8080";

function drawWidgetFramework($, widgetOuterContainer, widgetDetails, profileName, profileLevel, companyProfileName) {
	...
	drawWidgetReviews($, widgetDetails, profileName, profileLevel, companyProfileName);
	bindWidgetButtonActions($, widgetDetails);
...
function drawReviewSourcesSelection($, reviewSources) {
	...
	if (reviewSources == null || reviewSources == undefined || reviewSources.length == 0) {
...
function drawWidgetReviews($, widgetDetails, profileName, profileLevel, companyProfileName) {
	var startIndex = 0;
	var batchSize = 20;
	var reviewSortOrder = widgetDetails.widgetConfiguration.reviewSortOrder;
	var reviewSources = widgetDetails.widgetConfiguration.reviewSources;
	...
	callAjaxGetWithPayloadJsonpData($, urlPrefix+'/rest/widget/getreviews', function(data) {
...
function paintWidgetReviews($, reviews) {
	...
	for (var i = 0; i < reviews.length; i++) {
		...
		var reviewDateTimeStamp = parseInt(reviews[i].surveyTransactionDate);
		...
		if(profileImageUrl == null|| profileImageUrl == undefined || profileImageUrl == ''){
			profileImageUrl = urlPrefix+'/resources/widget/images/person.png';
...
function initializeWidget($, widgetOuterContainer, profileName, profileLevel, companyProfileName) {
	var payload = {
		"profileName" : profileName,
		"profileLevel" : profileLevel,
		"companyProfileName" : companyProfileName
	...
	var url = urlPrefix+'/rest/widget/getwidgetdetails';

	showWidgetDashOverlay($, '#ss-widget-dash');

	callAjaxGetWithPayloadJsonpData($, url, function(data) {
		drawWidgetFramework($, widgetOuterContainer, data, profileName, profileLevel, companyProfileName);
	}, function() {
...
function bindWidgetButtonActions($, widgetDetails) {
...
function getWidgetReviews($) {
	...
	callAjaxGetWithPayloadJsonpData($, urlPrefix+'/rest/widget/getreviews', function(data) {
		paintWidgetReviewsForLoadMore($, data);
...
function paintWidgetReviewsForLoadMore($, reviews) {
	...
	for (var i = 0; i < reviews.length; i++) {
		...
		var title = reviews[i].agentTitle;
		var rating = reviews[i].score;
		var customerName = reviews[i].customerFirstName + ' ' + reviews[i].customerLastName;
		var customerCity = reviews[i].city;
		var customerState = reviews[i].state;
		var review = reviews[i].review;
