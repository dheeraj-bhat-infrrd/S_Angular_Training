        ...
        <div class="row prof-pic-name-wrapper">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 prof-wrapper pos-relative prof-name-wrapper">
                <div class="prof-name-container">
                    <input class="prof-name prof-edditable" value="Anna Thomas">
<!--                    <div class="prof-name">Anna Thomas</div>-->
                    ...
                    <div class="prof-address">
                        <input class="prof-addline1 prof-edditable" value="Proidential Utah Elite Real Estate">
<!--                        <div class="prof-addline1">Proidential Utah Elite Real Estate</div>-->
                        <input class="prof-addline2 prof-edditable" value="574 South State Street Orem, UT 84058">
            ...
            <div class="prof-left-panel-wrapper margin-top-25 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="left-contact-wrapper">
                        ...
                        <div class="left-panel-content">
                            <div class="lp-con-row lp-row clearfix">
                                ...
                                <input class="float-left lp-con-row-item prof-edditable-sin" value="anna.thomas@domain.com">
                            </div>
                            <div class="lp-con-row lp-row clearfix">
                                <div class="float-left lp-con-icn icn-web"></div>
                                <input class="float-left lp-con-row-item blue-text prof-edditable-sin" value="anna.thomas@domain.com">
                            </div>
                            <div class="lp-con-row lp-row clearfix">
                                <div class="float-left lp-con-icn icn-mbl"></div>
                                <input class="float-left lp-con-row-item prof-edditable-sin" value="+1 (801) 123456789">
                            </div>
                            <div class="lp-con-row lp-row clearfix">
                ...
                <div class="prof-left-row prof-left-assoc bord-bot-dc">
                    <div class="left-assoc-wrapper">
                        ...
                        <div class="left-panel-content">
                            <input class="lp-assoc-row lp-row clearfix prof-edditable-sin" value="National Association of Realtors">
                            <input class="lp-assoc-row lp-row clearfix prof-edditable-sin" value="Independant Association of Realtors">
                            <input class="lp-assoc-row lp-row clearfix prof-edditable-sin" value="National Association of Realtors">
                        </div>
                    </div>
                </div>
                <div class="prof-left-row prof-left-expertise bord-bot-dc">
                    <div class="left-expertise-wrapper">
                        ...
                        <div class="left-panel-content">
                            <input class="lp-exp-row lp-row clearfix prof-edditable-sin" value="Buyer's Agent">
                            <input class="lp-exp-row lp-row clearfix prof-edditable-sin" value="Listing Agent">
                            <input class="lp-exp-row lp-row clearfix prof-edditable-sin" value="Foreclosure Agent">
                        </div>
                    </div>
                </div>
                <div class="prof-left-row prof-left-ach bord-bot-dc">
                    <div class="left-ach-wrapper">
                        ...
                        <div class="left-panel-content">
                            <input class="lp-ach-row lp-row clearfix prof-edditable-sin" value="Market Leader">
                            <input class="lp-ach-row lp-row clearfix prof-edditable-sin" value="Top Seller">
                        </div>
                    </div>
                </div>
                <div class="prof-left-row prof-left-hob bord-bot-dc">
                    <div class="left-hob-wrapper">
                        ...
                        <div class="left-panel-content">
                            <input class="lp-hob-row lp-row clearfix prof-edditable-sin" value="Bowling">
                            <input class="lp-hob-row lp-row clearfix prof-edditable-sin" value="Designing">
                        </div>
                    </div>
                </div>
                <div class="prof-left-row prof-left-auth bord-bot-dc">
                    <div class="left-auth-wrapper">
                        ...
                        <div class="left-panel-content">
                            <input class="lp-auth-row lp-row clearfix prof-edditable-sin" value="California (CA#1234556789)">
                            <input class="lp-auth-row lp-row clearfix prof-edditable-sin" value="N. Carolina (CA#1234556789">
                            <input class="lp-auth-row lp-row clearfix prof-edditable-sin" value="N. Jersey (CA#1234556789">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('.prof-edditable').focus(function(){
            $('.prof-edditable').addClass('prof-name-edit');
        });
        
        $('.prof-edditable').blur(function(){
            $('.prof-edditable').removeClass('prof-name-edit');
        });
        
        $('.prof-edditable-sin').focus(function(){
            $(this).addClass('prof-name-edit');
        });
        
        $('.prof-edditable-sin').blur(function(){
