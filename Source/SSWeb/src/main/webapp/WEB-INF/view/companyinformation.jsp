			...
			<div class="row login-row">
				<form id="company-info-form" method="POST" action="./addcompanyinformation.do" enctype="multipart/form-data">
					<div id="company-info-div" class="login-wrapper-resp padding-001 margin-top-25 margin-bottom-25 login-wrapper bg-fff margin-0-auto col-xs-12">
						...
						<div id="com-page-company" class="input-error-2 margin-0-auto">Please enter the above field</div>
						...
						<div id="com-page-address1" class="input-error-2 margin-0-auto">Please enter the above field</div>
                        <div class="login-input-wrapper margin-0-auto clearfix">
							<div class="float-left login-wrapper-icon icn-address"></div>
						...
						<div id="com-page-zipcode" class="input-error-2 margin-0-auto">Please enter the above field</div>
                        <div class="login-input-wrapper margin-0-auto clearfix">
						...
						<div id="com-page-contactno" class="input-error-2 margin-0-auto">Please enter the above field</div>
