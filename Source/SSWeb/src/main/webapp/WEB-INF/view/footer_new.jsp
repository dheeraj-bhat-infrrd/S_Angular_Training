<footer class="login-footer">
	<div class="container login-footer-container">
		<div class="footer-col-container row">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				...
				<div class="menu-sitelinks-container">
					<ul id="menu-sitelinks" class="menu">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				<div class="textwidget">
					<h3>SocialSurvey</h3>
					<p>
						Created by BuyersRoad, Inc. in San Francisco <br> <br>
						Report Bugs to <a href="mailto:support@socialsurvey.me">support@socialsurvey.me</a>
						<br> Press Inquiries: <a href="mailto:pr@socialsurvey.me">pr@socialsurvey.me</a>
					</p>
				</div>
			</div>
		</div>
