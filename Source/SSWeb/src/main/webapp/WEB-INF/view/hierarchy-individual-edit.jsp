...
<div class="bd-hr-form-item clearfix">
    <div class="float-left bd-frm-left"><spring:message code="label.individualname.key"/></div>
...
<div id="bd-assign-to" class="bd-hr-form-item clearfix">
    ...
    <div class="float-left bd-frm-right pos-relative">
        ...
        <div class="bd-frm-rt-dd-list dd-com-list hide">
        	<div data-option="office" class="bd-frm-rt-dd-item dd-com-item"><spring:message code="label.office.key"/></div>
...
<div id="bd-office-selector" class="bd-hr-form-item clearfix hide">
    <div class="float-left bd-frm-left"><spring:message code="label.selectoffice.key"/></div>
    <div class="float-left bd-frm-right pos-relative">
        <input class="bd-frm-rt-txt bd-frm-rt-dd bd-frm-rt-dd-adj dd-com-main bd-dd-img">
        <div class="bd-frm-rt-dd-list dd-com-list hide">
            <div data-option="office1" class="bd-frm-rt-dd-item dd-com-item">office1</div>
            <div data-option="office2" class="bd-frm-rt-dd-item dd-com-item">office2</div>
            <div data-option="office3" class="bd-frm-rt-dd-item dd-com-item">office3</div>
            <div data-option="office4" class="bd-frm-rt-dd-item dd-com-item">office4</div>
        </div>
    </div>
</div>
<div class="bd-hr-form-item clearfix">
