...
<body>
	<div class="err-wrapper-main">
		...
		<div class="error-main-wrapper container">
			<div class="err-line-1 text-center">OOPS !!! The page you are
				looking for cannot be found</div>
			<div class="err-line-2 text-center">404</div>
			<div class="err-line-3 text-center">
				<em>Lorem ipsumm dore eit lewht njbskjlhjn jb hhtreke Lorem
					ipsumm dore eit lewht njbskjlhjn jb hhtreke</em>
			</div>
		</div>
