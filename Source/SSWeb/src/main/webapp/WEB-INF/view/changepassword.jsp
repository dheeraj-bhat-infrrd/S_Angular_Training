									...
									<div class="hm-item-row cp-item-row clearfix">
										...
										<div class="hm-item-row-right">
											<input type="password" name="oldpassword" id=""
												class="hm-item-row-txt cp-item-row-txt" placeholder='Old Password'>
										...
										<div class="hm-item-row cp-item-row clearfix">
											...
											<div class="hm-item-row-right">
												<input type="password" name="newpassword" id=""
													class="hm-item-row-txt cp-item-row-txt" placeholder='New Password'>
												<div id="" class="input-error-2 error-msg"></div>
											</div>
										</div>
									</div>
										...
										<div class="hm-item-row cp-item-row clearfix">
											...
											<div class="hm-item-row-right">
												<input type="password" name="confirmnewpassword" id=""
													class="hm-item-row-txt cp-item-row-txt" placeholder='Confirm New Password'>
												<div id="" class="input-error-2 error-msg"></div>
											</div>
										</div>
									</div>
