...
<div class="v-um-edit-wrapper clearfix">
		...
		<form id="user-assignment-form">
			<div class="v-edit-row clearfix">
				...
				<div class="float-left v-ed-txt-sm">
					<input class="v-ed-txt-item" placeholder="<spring:message code='label.firstname.key'/>" value="${firstName}" readonly>
				</div>
				<div class="float-left v-ed-txt-sm v-ed-txt-sm-adj">
					<input class="v-ed-txt-item" placeholder="<spring:message code='label.lastname.key'/>" value="${lastName}" readonly>
				</div>
			</div>
			...
			<div class="v-edit-row clearfix">
				...
				<div class="float-left v-ed-txt">
					<input class="v-ed-txt-item" autocomplete="off" id="selected-user-txt" name="selectedUserEmail" placeholder="<spring:message code='label.emailid.key'/>" value="${emailId}" readonly>
	...
	<div id="btn-save-user-assignment" class="v-edt-btn-sav "><spring:message code="label.savechanges.key" /></div>
</div>