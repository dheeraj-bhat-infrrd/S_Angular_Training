	...
	<div id="report-abuse-overlay" class="overlay-main hide">
		<div id="report-abuse-pop-up" class="overlay-disable-wrapper">
			...
			<div class="ol-content">
				<input type="text" id="report-abuse-cus-name" class="report-abuse-input" placeholder="Name"> <input type="email" id="report-abuse-cus-email" class="report-abuse-input" placeholder="Email Address">
			...
			<div class="rpa-overlay-btn-cont clearfix">
				...
				<div class="rpa-btn rpa-cancel-btn ol-btn cursor-pointer float-right">
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 prof-wrapper pos-relative prof-name-wrapper ${profileNameClass}">
						<div class="prof-name-container" id="prof-company-head-content">
								...
								<c:when test="${reviewsCount > 0 }">
									<div itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" class="prof-rating clearfix">
										<div class="prof-rating-wrapper maring-0 clearfix float-left" id="rating-avg-comp">
											...
											<div class='rating-rounded float-left' data-score="${floatingAverageRating}">
												<span itemprop="ratingValue">${floatingAverageRating}</span> -
											</div>
										</div>
										<div class="float-left review-count-left cursor-pointer" id="prof-company-review-count">
							...
							<div class="prof-btn-wrapper clearfix">
								<div class="prof-btn-contact float-left" onclick="focusOnContact()">
									Contact
									<c:choose>
					...
					<div class="mob-contact-btn-wrapper">
						<div class="mob-contact-btn-row clearfix">
							<div class="mob-contact-btn float-left">
								<div id="mob-contact-btn" class="mob-prof-contact-btn float-right" onclick="focusOnContact()">
									Contact
									<c:choose>
										<c:when test="${not empty agentFirstName}"> ${agentFirstName}</c:when>
										<c:otherwise> ${profName}</c:otherwise>
					...
					<div class="prof-details-header-row clearfix">
						<c:if test="${not empty profile.completeProfileUrl}">
							<div class="prof-link-header float-left clearfix">
								...
								<div id="prof-header-url" class="rating-image-txt float-left" title="${profile.completeProfileUrl}">${profile.completeProfileUrl}</div>
							</div>
						</c:if>
										...
										<div class="left-panel-content" id="prof-contact-information">
											<c:if test="${not empty profile.contact_details.web_addresses && not empty profile.contact_details.web_addresses.work}">
												<div class="lp-con-row lp-row clearfix">
													...
													<div id="web-addr-link-lp" class="float-left lp-con-row-item pp-lp-con-row-item blue-text web-address-link" data-link="${profile.contact_details.web_addresses.work}"></div>
												</div>
											</c:if>
								...
								<c:choose>
									...
									<c:when test="${not empty companyProfileName}">
										<div id="comp-hierarchy" class="prof-left-row prof-left-assoc bord-bot-dc hide">
											<div class="left-assoc-wrapper">
												<input type="hidden" id="regionid-hidden" /> <input type="hidden" id="branchid-hidden" />
												<div class="left-panel-header">
										...
										<form id="prof-contact-form">
											...
											<div class="lp-row">
												<div class="lp-input-cont lp-textarea-cont">
													...
													<textarea id="lp-input-message" class="lp-input" placeholder='<spring:message code="label.publicprofile.contactus.textplaceholder.key"/>'></textarea>
												</div>
											</div>
											<div class="lp-row">
											...
											<div class="lp-row">
												<div class="lp-button">
													<spring:message code="label.publicprofile.submitmessage.key" />
												</div>
											</div>
											...
											<div id="privacy-policy-link" class="privacy-policy-link">
												<a href="https://www.socialsurvey.me/survey/privacy-policy/">Privacy Policy</a>
											</div>
										</form>
									</div>
						...
						<div class="rt-content-main bord-bot-dc clearfix" id="recent-post-container" style="display: none;">
							<div class="float-left panel-tweet-wrapper">
								<div class="main-con-header">
									<spring:message code="label.publicprofile.recentpost.key" />
								</div>
						...
						<div class="people-say-wrapper rt-content-main" id="reviews-container" style="display: none;">
							<div class="clearfix hide" style="display: block; border-bottom: 1px solid #dcdcdc; padding: 15px 0;">
								<div class="main-con-header float-left" id="prof-reviews-header">
									<span class="ppl-say-txt-st"><spring:message code="label.peoplesayabout.key" /></span> <span class="review-for-text-sm-screen"><spring:message code="label.reviewsfor.key" /></span> &nbsp;${profName }
								</div>
								<div id="prof-reviews-sort" class="prof-reviews-sort clearfix float-right">
									<div id="sort-by-feature" class="prof-review-sort-link float-left">
										<spring:message code="label.sortbyfeature.key" />
									</div>
									<div class="prof-reviews-sort-divider float-left">|</div>
									<div id="sort-by-date" class="prof-review-sort-link float-right">
