...
<body>
	...
	<input type="hidden" id="profile-fetch-info" fetch-all-reviews="false"
		total-reviews="0" profile-level="${profileLevel}" />
	...
	<div id="profile-main-content"
		class="prof-main-content-wrapper margin-top-25 margin-bottom-25 hide">
		<div class="container">
			<div class="row prof-pic-name-wrapper">
				...
				<div
					class="col-lg-4 col-md-4 col-sm-4 col-xs-6 prof-wrapper pos-relative prof-name-wrapper">
				...
				<div
					...
					<div class="prof-left-row prof-left-info bord-bot-dc">
						<div class="left-contact-wrapper">
							<div class="left-panel-header cursor-pointer vcard-download">Download
								VCard</div>
						</div>
					</div>
					<div id="contact-info"
						class="prof-left-row prof-left-info bord-bot-dc hide">
						<div class="left-contact-wrapper">
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/profile_common.js"></script>
	<script
