		...
		<div class="reg_form_wrapper_2">
			...
			<div class="reg_form_row clearfix">
				...
				<div class="float-left rfr_txt">
					...
					<div class="rfr_txt_fld">
						<input type="email" class="rfr_input_fld" id="user-email"
							data-non-empty="true" name="customer-emailId"
							placeholder='<spring:message code="label.customeremail.key"/>'>
					</div>
				</div>
			</div>
			<div class="reg_form_row clearfix">
				<div class="float-left rfr_lbl">
					<spring:message code="label.sendinviteto.key" />
				</div>
				<div class="float-left rfr_txt">
					<div class="rfr_icn icn-email"></div>
					<div class="rfr_txt_fld">
						<input type="email" class="rfr_input_fld" id="custom-email"
							data-non-empty="true" name="specified-emailId"
							placeholder='<spring:message code="label.invitemail.key"/>'>
					</div>
				</div>
			</div>
			<div class="reg_form_row clearfix">
				<div class="reg_btn" id="send-invite-form-submit">
...
$(document).ready(function(){
	$(document).attr("title", "Send Invite for Invoiced Account");
});
</script>