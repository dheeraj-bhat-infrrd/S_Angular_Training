		...
		<div class="container login-container">
			<div class="row login-row">
				<form id="forgot-pwd-form" method="POST"
					action="./sendresetpasswordlink.do">
					<div id="forgot-pwd-div"
						...
						<div class="login-input-wrapper margin-0-auto clearfix">
							...
							<input class="float-left login-wrapper-txt" id="login-user-id"
								data-non-empty="true" data-email="" name="emailId"
				...
				<div
					...
					<div class="float-right cursor-pointer">
						<a class="login-link" href="./login.do"><spring:message
