        ...
        <div class="hm-header-main-wrapper">
            <div class="container">
                <div class="hm-header-row hm-header-row-main clearfix">
                    <div class="text-center err-header-row">404 - No Active profiles found</div>
                </div>
            </div>
        </div>

        <div class="error-main-wrapper container">
            <div class="err-line-1 text-center">OOPS!!! No Active profiles found</div>
            <div class="err-line-2 text-center">Please contact your administrator to activate your profile</div>
            <!-- <div class="err-page-btn">Go back to Homepage</div> -->
            <div class="err-line-3 text-center"></div>
        </div>
