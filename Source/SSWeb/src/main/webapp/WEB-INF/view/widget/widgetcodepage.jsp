...
$(document).ready(function() {
	...
	if (iden == undefined || profileLevel == undefined || profileLevel == ""){
		...
		body = "&lt;iframe id = \"ss-widget-iframe\" src=\"" + appBaseUrl +  "rest/widget/" + profileLevel + "/" + iden + "\" frameborder=\"0\" width=\"100%\" height=\"500px\" style=\"overflow-y: scroll;\" &gt&lt/iframe&gt;";
