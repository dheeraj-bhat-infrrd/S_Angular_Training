...
<body>
	<div class="err-wrapper-main">
			...
			<div class="container clearfix">
				...
				<div class="header-user-info float-right clearfix">
					<c:if test="${displaylogo != null}">
						...
						<div class="float-left user-error-logo "
							style="background: url(${displaylogo}) no-repeat center; background-size: 100% auto;">
		...
		<div class="error-main-wrapper container">
			...
			<div class="err-line-3 text-center">If this persists, please send a quick message to <u>support@socialsurvey.com</u> 
				and tell us what you did to get this error page, so we can get it fixed.</div>
		</div>
