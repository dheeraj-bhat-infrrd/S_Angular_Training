...
<body>
	<div class="err-wrapper-main">
        ...
        <div class="hm-header-main-wrapper">
            <div class="container">
                <div class="hm-header-row hm-header-row-main clearfix">
                    <div class="text-center err-header-row">Link Invalid</div>
                </div>
            </div>
        </div>
        ...
        <div class="error-main-wrapper container">
            ...
            <div class="err-line-2 text-center">Please Find the Latest Valid Link in Your Mail to Retake the Survey.</div>
