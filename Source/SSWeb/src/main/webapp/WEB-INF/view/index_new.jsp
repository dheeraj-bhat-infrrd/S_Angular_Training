                ...
                <div class="float-right header-login-wrapper clearfix">
                    <div class="float-left h-email-wrapper">
                        ...
                        <div class="h-inp-wrapper">
                            <input type="text" class="h-inp" placeholder="Username">
                        </div>
                    </div>
                    <div class="float-left h-pwd-wrapper">
                        <div class="h-lbl clearfix">
                            <div class="float-left">Password</div>
                            <div class="float-right fgt-pwd">Forgot your Password?</div>
                        </div>
                        <div class="h-inp-wrapper">
                            <input type="text" class="h-inp" placeholder="Password">
                        </div>
                    </div>
                    <div class="float-left h-login-btn-wrapper">
                        <div class="h-btn-login"></div>
                    </div>
                </div>
            </div>
...
-->
                ...
                <div class="float-left c-reg-panel">
                    ...
                    <div class="clearfix reg-item">
                        <input class="reg-inp reg-inp-1" placeholder="First Name">
                        <input class="reg-inp reg-inp-2" placeholder="Last Name">
                    </div>
                    <div class="clearfix reg-item">
                        <input class="reg-inp reg-inp-3" placeholder="Email">
                    </div>
                    ...
                    <div class="clearfix reg-item">
                        <input type="button" class="reg-inp reg-btn" value="Submit">
                    </div>
                </div>
            </div>
