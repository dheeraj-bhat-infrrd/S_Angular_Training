<div id="stream-dup-cont" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 soc-mon-post-container dup-padding">
		<div class="dup-icn-cont col-lg-1 col-md-1 col-sm-1 col-xs-1">
			<input type="hidden" class="post-id-details" data-post-id=>
			<img src="${initParam.resourcesPath}/resources/images/flag-gray.png" class=" dup-stream-unflagged-icn hide float-left soc-mon-post-icn">
			<img src="${initParam.resourcesPath}/resources/images/flag-yellow.png" class="dup-stream-flagged-icn hide float-left soc-mon-post-icn">
