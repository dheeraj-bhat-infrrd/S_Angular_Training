...
var widgetReviewFbPosTemplate = '<div id="ss-widget-review-container" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev hide" data-index=0>' + '<div class="w-100 ss-widget-date-pow-cont">' + '<div class="float-left ss-widget-rev-date ss-widget-rev-font"></div>' + '<div class="float-right ss-widget-prov-by ss-widget-pow-by ss-widget-rev-font">provided by <div class=" ss-wi-verified-partner-badge ss-wi-verify-partner-image ss-widget-verified-badge ss-wi-verified-badge  ss-wi-verify-image ss-wi-zillow-badge  ss-wi-verify-image-zillow ss-wi-unverified-badge  ss-wi-verify-image-ss ss-fb-verified-image ss-verify-image-fb float-right" ></div></div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-details">' + '<div class="ss-widget-prof-pic-cont"><img src="/resources/images/image_pt.png" class="ss-widget-prof-pic"></div>' + '<div class="ss-widget-rev-prof-details">' + '<div class="ss-widget-prov-by  ss-widget-rev-font">In reference to a transaction with</div>' + '<div class="ss-widget-rev-prof-name ss-widget-rev-font"></div>' + '<div class="ss-widget-rev-prof-title ss-widget-rev-font"> | NMLS# </div>' + '</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-fb-recom-div">' + '<div class="ss-widget-fb-recommendation-cont-pos"><div class="ss-widget-fb-recom">Positive</div></div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-cust-name-div  ss-widget-rev-font"><span class="ss-widget-rev-cust-name  ss-widget-rev-font">Stacey M </span><span class="ss-widget-rev-cust-addr  ss-widget-rev-font">- Los Angeles, CA</span></div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-text-cont">' + '<div class="ss-widget-rev-text-quote">&#10075;</div>' + '<div class="ss-widget-rev-text-quote">&#10075;</div>' + '<div class="ss-widget-rev-text">' + '<p class="ss-widget-review-text ss-widget-rev-font">Sample</p>' + '<p class="ss-widget-text-bold ss-widget-read-more cursor-pointer ss-widget-rev-font">... read more</p>' + '</div>' + '</div>' + '</div>';
var widgetReviewFbNegTemplate = '<div id="ss-widget-review-container" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev hide" data-index=0>' + '<div class="w-100 ss-widget-date-pow-cont">' + '<div class="float-left ss-widget-rev-date ss-widget-rev-font"></div>' + '<div class="float-right ss-widget-prov-by ss-widget-pow-by ss-widget-rev-font">provided by <div class=" ss-wi-verified-partner-badge ss-wi-verify-partner-image ss-widget-verified-badge ss-wi-verified-badge  ss-wi-verify-image ss-wi-zillow-badge  ss-wi-verify-image-zillow ss-wi-unverified-badge  ss-wi-verify-image-ss ss-fb-verified-image ss-verify-image-fb float-right" ></div></div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-details">' + '<div class="ss-widget-prof-pic-cont"><img src="/resources/images/image_pt.png" class="ss-widget-prof-pic"></div>' + '<div class="ss-widget-rev-prof-details">' + '<div class="ss-widget-prov-by  ss-widget-rev-font">In reference to a transaction with</div>' + '<div class="ss-widget-rev-prof-name ss-widget-rev-font"></div>' + '<div class="ss-widget-rev-prof-title ss-widget-rev-font"> | NMLS# </div>' + '</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-fb-recom-div">' + '<div class="ss-widget-fb-recommendation-cont-neg"><div class="ss-widget-fb-recom">Negetive</div></div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-cust-name-div  ss-widget-rev-font"><span class="ss-widget-rev-cust-name  ss-widget-rev-font">Stacey M </span><span class="ss-widget-rev-cust-addr  ss-widget-rev-font">- Los Angeles, CA</span></div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-text-cont">' + '<div class="ss-widget-rev-text-quote">&#10075;</div>' + '<div class="ss-widget-rev-text-quote">&#10075;</div>' + '<div class="ss-widget-rev-text">' + '<p class="ss-widget-review-text ss-widget-rev-font">Sample</p>' + '<p class="ss-widget-text-bold ss-widget-read-more cursor-pointer ss-widget-rev-font">... read more</p>' + '</div>' + '</div>' + '</div>';
