...
var widgetFrameworkMobView = '<div id="ss-widget-container" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 widget-pad-zero bootstrap-ss-widget">' + '<div id="ss-widget-dash" class="hide" ></div>' + '<div id="ss-widget-options" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 widget-left-pad-zero widget-right-pad-zero ss-widget-options-container">' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rating-btn-cont">' + '<div class="ss-widget-avg-rating-cont ss-widget-rat-con-sm">' + '<div id="ss-widget-rating" class="ss-widget-rating ss-widget-font">0</div>' + '<div id="ss-widget-rating-stars" class="ss-widget-rating-stars">' + '<div class="ss-widget-star-box">' + '<div class="ss-widget-star1 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-star2 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-star3 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-star4 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-star5 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '</div>' + '</div>' + '<div id="ss-widget-rev-count" class="ss-widget-rev-count">0 Reviews</div>' + '</div>' + '<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 ss-widget-btns-container ss-widget-btn-cont-sm">' + '<div id="widget-contact-us-btn" style="margin-top:5px !important" class="widget-btns-sm widget-contact-us-btn ss-widget-font" data-link="" title="CONTACT US">CONTACT US</div>' + '<div id="widget-write-rev-btn" class="widget-btns-sm ss-widget-font" data-link="" title="WRITE A REVIEW">WRITE A REVIEW</div>' + '</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 widget-pad-zero ss-widget-rating-detils-container">' + '<div id="ss-widget-rating-details" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rating-details ss-widget-font">' + 'Rating Details <span class="float-right" style="font-size:  13px;">&#9662;</span>' + '</div>' + '<div id="ss-widget-rating-cont" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rating-cont">' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero  widget-star-blue ss-widget-bar-star-sm">&#9733; &#9733; &#9733; &#9733; &#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero ss-widget-bar-sm">' + '<div id="ss-widget-5star-bar" class="ss-widget-rating-bar widget-blue-bar"></div>' + '</div>' + '<div id="ss-widget-5star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc-sm ss-widget-font">0%</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero  widget-star-green ss-widget-bar-star-sm">&#9733; &#9733; &#9733; &#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero ss-widget-bar-sm">' + '<div id="ss-widget-4star-bar" class="ss-widget-rating-bar widget-green-bar"></div>' + '</div>' + '<div id="ss-widget-4star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc-sm ss-widget-font">0%</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero  widget-star-yellow ss-widget-bar-star-sm">&#9733; &#9733; &#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero ss-widget-bar-sm">' + '<div id="ss-widget-3star-bar" class="ss-widget-rating-bar widget-yellow-bar"></div>' + '</div>' + '<div id="ss-widget-3star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc-sm ss-widget-font">0%</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero  widget-star-orange ss-widget-bar-star-sm">&#9733; &#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero ss-widget-bar-sm">' + '<div id="ss-widget-2star-bar" class="ss-widget-rating-bar widget-orange-bar"></div>' + '</div>' + '<div id="ss-widget-2star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc-sm ss-widget-font">0%</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-star-cont">' + '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 widget-pad-zero  widget-star-red ss-widget-bar-star-sm">&#9733; </div>' + '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 widget-pad-zero ss-widget-bar-sm">' + '<div id="ss-widget-1star-bar" class="ss-widget-rating-bar widget-red-bar"></div>' + '</div>' + '<div id="ss-widget-1star-perc" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ss-widget-rating-perc-sm ss-widget-font">0%</div>' + '</div>' + '</div>' + '</div>' + '<div id="ss-widget-opt" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-opt-cont">' + '<div id="ss-widget-opt-hdr" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-opt-text ss-widget-font cursor-pointer">Options<span id="ss-widget-options-arrow" class="float-right cursor-pointer" style="font-size:  13px;">&#9662;</span></div>' + '<div id="ss-widget-options-dropdown" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-options-dropdown">' + '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ss-widget-opt">' + '<div class="w-100 ss-widget-opt-head-text ss-widget-font">Filter Source</div>' + '<div>' + '<input type="checkbox" id="widget-opt-all" name="filterSource" value="all" checked />' + '<label for="scales" class="ss-widget-font">All</label>' + '</div>' + '<div>' + '<input type="checkbox" id="widget-opt-ss" name="filterSource" value="ss" checked />' + '<label for="scales" class="ss-widget-font">SocialSurvey</label>' + '</div>' + '<div>' + '<input type="checkbox" id="widget-opt-ssv" name="filterSource" value="ssv" checked />' + '<label for="scales" class="ss-widget-font">SocialSurvey Verified</label>' + '</div>'
/*
 * + '<div>' + '<input type="checkbox" id="widget-opt-goo" name="filterSource" value="google" checked />' + '<label for="scales" class="ss-widget-font">Google</label>' + '</div>'
 */
+ '<div>' + '<input type="checkbox" id="widget-opt-zil" name="filterSource" value="zillow" checked />' + '<label for="scales" class="ss-widget-font">Zillow</label>' + '</div>'
 ...
 * + '<div>' + '<input type="checkbox" id="widget-opt-fb" name="filterSource" value="fb" checked />' + '<label for="scales" class="ss-widget-font">Facebook</label>' + '</div>' + '<div>' + '<input type="checkbox" id="widget-opt-lin" name="filterSource" value="linkedin" checked />' + '<label for="scales">LinkedIn</label>' + '</div>'
 */
+ '</div>' + '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ss-widget-order-cont">' + '<div id="ss-widget-order-data" class="w-100 ss-widget-opt-head-text ss-widget-font" data-order="">Order By</div>' + '<div id="ss-widget-newest" class="w-100 ss-widget-order-text  ss-widget-font" data-order=1>Newest First</div>' + '<div id="ss-widget-oldest" class="w-100 ss-widget-order-text  ss-widget-font" data-order=2>Oldest First</div>' + '<div id="ss-widget-highest" class="w-100 ss-widget-order-text  ss-widget-font" data-order=3>Highest Rating</div>' + '<div id="ss-widget-lowest" class="w-100 ss-widget-order-text  ss-widget-font" data-order=4>Lowest Rating</div>' + '<div id="ss-widget-feature" class="w-100 ss-widget-order-text  ss-widget-font" data-order=5>Featured Reviews</div>' +'</div>' + '</div>' + '</div>' + '</div>' + '<div id="ss-widget-reviews" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-cont">' + '<div class="w-100 ss-widget-rev-head ss-widget-font">Reviews <span id="ss-widget-rev-options" class="float-right cursor-pointer ss-widget-font">Options &#9662;</span></div><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-review-div-container">' + '<div id="ss-widget-review-div" class="w-100" data-allReviews=[] data-zillow=[] data-initialRev=1 data-maxLoadRev=1 data-startIndex=0 data-batchSize=1 data-index=0 data-nextBatchIndex=0 data-widgetDetails></div>' + '</div><div id="ss-widget-load-more-cont" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">' + '<div id="ss-widget-load-more-btn" class="ss-widget-load-more-btn ss-widget-font">Load More</div>' + '</div>' + '<div id="ss-widget-modest-branding" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-powered-by ss-widget-font hide">' + 'Powered by <span class="ss-widget-text-bold ss-widget-font">SocialSurvey</span>' + '</div>' + '</div>' + '</div>';

var widgetReviewTemplate = '<div id="ss-widget-review-container" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev hide" data-index=0>' + '<div class="w-100 ss-widget-date-pow-cont">' + '<div class="float-left ss-widget-rev-date ss-widget-rev-font"></div>' + '<div class="float-right ss-widget-prov-by ss-widget-pow-by ss-widget-rev-font">provided by <div class=" ss-wi-verified-partner-badge ss-wi-verify-partner-image ss-widget-verified-badge ss-wi-verified-badge  ss-wi-verify-image ss-wi-zillow-badge  ss-wi-verify-image-zillow ss-wi-unverified-badge  ss-wi-verify-image-ss ss-fb-verified-image ss-verify-image-fb float-right" ></div></div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-details">' + '<div class="ss-widget-prof-pic-cont"><img src="/resources/images/image_pt.png" class="ss-widget-prof-pic"></div>' + '<div class="ss-widget-rev-prof-details">' + '<div class="ss-widget-prov-by  ss-widget-rev-font">In reference to a transaction with</div>' + '<div class="ss-widget-rev-prof-name ss-widget-rev-font"></div>' + '<div class="ss-widget-rev-prof-title ss-widget-rev-font"> | NMLS# </div>' + '</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-stars">' + '<div class="ss-widget-star1 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-star2 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-star3 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-star4 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-star5 ss-widget-star-ratings-cont"><div class="ss-widget-empty-stars"></div><div id="" class="ss-widget-full-stars" style="width:0%"></div></div>' + '<div class="ss-widget-rev-score  ss-widget-rev-font">0.0</div>' + '</div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-cust-name-div  ss-widget-rev-font"><span class="ss-widget-rev-cust-name  ss-widget-rev-font">Stacey M </span><span class="ss-widget-rev-cust-addr  ss-widget-rev-font">- Los Angeles, CA</span></div>' + '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ss-widget-rev-text-cont">' + '<div class="ss-widget-rev-text-quote">&#10075;</div>' + '<div class="ss-widget-rev-text-quote">&#10075;</div>' + '<div class="ss-widget-rev-text">' + '<p class="ss-widget-review-text ss-widget-rev-font">Sample</p>' + '<p class="ss-widget-text-bold ss-widget-read-more cursor-pointer ss-widget-rev-font">... read more</p>' + '</div>' + '</div>' + '</div>';
var widgetOuterCon;
...
function drawWidgetFramework($, widgetOuterContainer, widgetDetails, profileName, profileLevel, companyProfileName, resourcesHost, ssHost) {
	...
	if (widgetOuterContainer.width() < 275) {
...
function drawWidgetStyleElements($, widgetDetails) {
	...
	$('#widget-contact-us-btn').attr('title', widgetDetails.widgetConfiguration.buttonOneName);
	$('#widget-write-rev-btn').attr('title', widgetDetails.widgetConfiguration.buttonTwoName);
	...
	$('head').append('<style>#ss-widget-rating-stars .ss-widget-empty-stars:before {-webkit-text-stroke: 1px '+ratingAndStarColor+' !important;} #ss-widget-rating-stars .ss-widget-full-stars:before { -webkit-text-stroke: 1px '+ratingAndStarColor+' !important;}</style>');
	$('#ss-widget-rating-stars ').find('.ss-widget-full-stars').css('color',ratingAndStarColor);
...
function paintWidgetReviews($, reviews, resourcesHost, ssHost) {
	...
	for (var i = 0; i < reviews.length; i++) {
		...
		/* Replies Start */
		if (reviews[i]['reviewReply']) {
			let reviewsHtml = '';
			// reviewsHtml += `<div class="review-reply-section">
			// 				<h5><span><b>Replies</b></span></h5>							
			// 				<div class="review-reply-container">`;
			reviewsHtml += `<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 review-reply-section" style="margin-top:0px; font-size:12px;">							
							<div class="review-reply-container">`;

			reviews[i].reviewReply.forEach(function (v) {
				reviewsHtml += `<div class="review-reply-box" data-reply-id="${v.replyId}" style="padding-left:15px">
			...
			reviewsHtml += '</div></div>';
			$('#ss-widget-review-container-' + i).append(reviewsHtml);
		}
		/* Replies End */
...
function paintWidgetReviewStyles($, widgetDetails) {
	...
	$('head').append('<style>#ss-widget-review-div .ss-widget-empty-stars:before {-webkit-text-stroke: 1px '+ratingAndStarColor+' !important;} #ss-widget-review-div .ss-widget-full-stars:before { -webkit-text-stroke: 1px '+ratingAndStarColor+' !important;}</style>');
	$('.ss-widget-rev-stars').find('.ss-widget-full-stars').css('color',ratingAndStarColor);
...
function drawWidgetRatingStars($, parent, averageRating) {
	...
	if (Math.floor(averageRating) == averageRating) {
		...
		case 1:
			parent.find('.ss-widget-star1').find('.ss-widget-full-stars').css('width','100%');
			break;
		case 2:
			parent.find('.ss-widget-star1').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star2').find('.ss-widget-full-stars').css('width','100%');
			break;
		case 3:
			parent.find('.ss-widget-star1').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star2').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star3').find('.ss-widget-full-stars').css('width','100%');
			break;
		case 4:
			parent.find('.ss-widget-star1').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star2').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star3').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star4').find('.ss-widget-full-stars').css('width','100%');
			break;
		case 5:
			parent.find('.ss-widget-star1').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star2').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star3').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star4').find('.ss-widget-full-stars').css('width','100%');
			parent.find('.ss-widget-star5').find('.ss-widget-full-stars').css('width','100%');
			break;
		}
	} else {
		if (Math.floor(averageRating) < 1) {
			...
			if (averageRating > 0.55) {
				parent.find('.ss-widget-star1').find('.ss-widget-full-stars').css('width','66%');
			} else if (averageRating > 0.25) {
				parent.find('.ss-widget-star1').find('.ss-widget-full-stars').css('width','51%');
			} else {
				parent.find('.ss-widget-star1').find('.ss-widget-full-stars').css('width','36%');
			}
			...
			if (averageRating > 1.55) {
				parent.find('.ss-widget-star2').find('.ss-widget-full-stars').css('width','66%');
			} else if (averageRating > 1.25) {
				parent.find('.ss-widget-star2').find('.ss-widget-full-stars').css('width','51%');
			} else {
				parent.find('.ss-widget-star2').find('.ss-widget-full-stars').css('width','36%');
			}
			...
			if (averageRating > 2.55) {
				parent.find('.ss-widget-star3').find('.ss-widget-full-stars').css('width','66%');
			} else if (averageRating > 2.25) {
				parent.find('.ss-widget-star3').find('.ss-widget-full-stars').css('width','51%');
			} else {
				parent.find('.ss-widget-star3').find('.ss-widget-full-stars').css('width','36%');
			}
			...
			if (averageRating > 3.55) {
				parent.find('.ss-widget-star4').find('.ss-widget-full-stars').css('width','66%');
			} else if (averageRating > 3.25) {
				parent.find('.ss-widget-star4').find('.ss-widget-full-stars').css('width','51%');
			} else {
				parent.find('.ss-widget-star4').find('.ss-widget-full-stars').css('width','36%');
			}
		} else {
			...
			if (averageRating > 4.55) {
				parent.find('.ss-widget-star5').find('.ss-widget-full-stars').css('width','66%');
			} else if (averageRating > 4.25) {
				parent.find('.ss-widget-star5').find('.ss-widget-full-stars').css('width','51%');
			} else {
				parent.find('.ss-widget-star5').find('.ss-widget-full-stars').css('width','36%');
			}
		}
	}
